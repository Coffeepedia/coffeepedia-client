export default function MenuCard() {
  return (
    <div className="grid justify-items-stretch grid-cols-2 gap-4 p-2 mb-[55px]">
      <div className="justify-self-center h-[325px] w-[187px]">
        <div className="flex flex-col items-center bg-[#9FC088] rounded-[15px] p-2 h-[296px] w-[187px] shadow-lg">
          ...
          <div className="flex flex-col justify-center h-48">
            <img
              src="https://cdn-icons.flaticon.com/png/128/1047/premium/1047462.png?token=exp=1653056087~hmac=df424f91d45d7b4a5119be1eeabb23a5"
              alt=""
      ...
      <div className="justify-self-center h-[325px] w-[187px]">
        <div className="flex flex-col items-center bg-[#CC704B] rounded-[15px] p-2 h-[296px] w-[187px] shadow-lg">
          <p className="text-2xl font-semibold text-white">45K</p>
          <div className="flex flex-col justify-center h-48">
            <img
              src="https://cdn-icons.flaticon.com/png/128/1047/premium/1047462.png?token=exp=1653056087~hmac=df424f91d45d7b4a5119be1eeabb23a5"
      ...
      <div className="justify-self-center h-[325px] w-[187px]">
        <div className="flex flex-col items-center bg-[#E8C07D] rounded-[15px] p-2 h-[296px] w-[187px] shadow-lg">
          <p className="text-2xl font-semibold text-white">45K</p>
          <div className="flex flex-col justify-center h-48">
            <img
              src="https://cdn-icons.flaticon.com/png/128/1047/premium/1047462.png?token=exp=1653056087~hmac=df424f91d45d7b4a5119be1eeabb23a5"
      ...
      <div className="justify-self-center h-[325px] w-[187px]">
        <div className="flex flex-col items-center bg-[#557B83] rounded-[15px] p-2 h-[296px] w-[187px] shadow-lg">
          <p className="text-2xl font-semibold text-white">45K</p>
          <div className="flex flex-col justify-center h-48">
            <img
              src="https://cdn-icons.flaticon.com/png/128/1047/premium/1047462.png?token=exp=1653056087~hmac=df424f91d45d7b4a5119be1eeabb23a5"
