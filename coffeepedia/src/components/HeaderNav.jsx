  ...
  return (
    <nav className="rounded border-gray-200 py-2.5 dark:bg-gray-800">
      <div className="container mx-auto flex flex-row items-center justify-between px-4">
        <button
          type="button"
          className="ml-3 rounded-lg text-sm text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
        >
          <img
