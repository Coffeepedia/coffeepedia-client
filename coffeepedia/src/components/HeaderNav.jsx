export default function HeaderNav() {
  return (
    <nav class="border-gray-200 py-2.5 rounded dark:bg-gray-800">
      <div class="container px-4 flex flex-wrap justify-between items-center mx-auto">
        <button
          data-collapse-toggle="mobile-menu"
          type="button"
          class="inline-flex items-center ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
        ...
        <div className="bg-white p-3 mr-2 rounded-full drop-shadow-lg hover:bg-gray-300">
